...
##PFOCR
PFOCR_REL=$(curl --silent https://wikipathways-data.wmcloud.org/pfocr/ | grep -o 'href=".*">pfocr' | sed 's/href=\"//;s/\">pfocr//' | tail -n 1)
wget -O "shiny_run/databases/gmts/pfocr_hs_"${DATE}".gmt" "https://wikipathways-data.wmcloud.org/pfocr/"${PFOCR_REL}
